...
class TextInputTechnique(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.wordlist = QtCore.QStringListModel()
        self.wordlist.setStringList(["The", "five", "boxing", "wizards", "jump", "quickly", "quick"])

        self.workingCompleter = QtWidgets.QCompleter()
        self.workingCompleter.setCaseSensitivity(False)
        self.workingCompleter.setModel(self.wordlist)
        ...
        self.sentenceTyped()
        self.workingCompleter.setWidget(self.ui.EnterTextEdit)
        #self.ui.EnterTextEdit.setCompleter(self.workingCompleter)
    '''
        #self.completer.setModel(self.wordlist)
        #self.completer.setWidget(self.ui.EnterTextEdit)
        #self.completer = TagsCompleter(self.wordlist, self.ui.EnterTextEdit)
    '''
    ...
    def initUI(self):
        ...
        #
        self.ui.EnterTextEdit.spacePressed.connect(self.delimiterPressed)

    def delimiterPressed(self):
    	print("YOYOYO")

    # if text was edited
    def editedText(self):
        #self.workingCompleter.setCompletionPrefix("")
        
        print("PREFIX: %s" %self.workingCompleter.completionPrefix()[:-1])
        if self.workingCompleter.completionPrefix().endswith(" "):
        	print("LEER")
        	self.workingCompleter.setCompletionPrefix("")
        	print("neu: %s" %self.workingCompleter.completionPrefix())
        	self.workingCompleter.complete()
        #self.completer.update(self.wordlist, self.ui.EnterTextEdit.text())
